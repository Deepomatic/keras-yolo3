...
def train(config_path):
    ...
    frozen_layers_training = False
    full_training = True

    # Train with frozen layers first, to get a stable loss.
    # Adjust num epochs to your dataset. This step is enough to obtain a not bad model.
    if frozen_layers_training is True:
        ...
        train_data = data_generator_wrapper(train_lines,
                                            batch_size,
                                            input_shape,
                                            anchors,
                                            num_classes)
        val_data = data_generator_wrapper(val_lines,
                                          batch_size,
                                          input_shape,
                                          anchors,
                                          num_classes)
...
if __name__ == '__main__':
    ...
    if FLAGS.config_path:
        ...
        print("Must specify at least config_path.  See usage with --help.")
